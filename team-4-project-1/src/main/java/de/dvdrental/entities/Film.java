...
public class Film {
    ...
    //Mehrere Filme können diesselbe Kategorie haben, demnach hat ein Film auch immer nur eine Kategorie
    ...
    public boolean equals(Object o) {
        ...
        return filmId == film.filmId &&
                rentalDuration.equals(film.rentalDuration) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(filmId, title, description, releaseYear, rentalDuration, rentalRate, length, replacementCost, rating, lastUpdate, language);
    }
