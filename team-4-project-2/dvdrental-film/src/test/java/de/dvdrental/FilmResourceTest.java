...
class FilmResourceTest {
    ...
    void testGetFilmActors() {
        given()
                ...
                .statusCode(200)
                .body("size()", is(5),
                        "[0].firstname-lastname", is("Gary Phoenix"),
                        "[0].href", is("http://localhost:8083/actors/51"),
                        "[1].firstname-lastname", is("Dustin Tautou"),
                        "[1].href", is("http://localhost:8083/actors/59"),
                        "[2].firstname-lastname", is("Matthew Leigh"),
                        "[2].href", is("http://localhost:8083/actors/103"),
                        "[3].firstname-lastname", is("Matthew Carrey"),
                        "[3].href", is("http://localhost:8083/actors/181"),
                        "[4].firstname-lastname", is("Thora Temple"),
                        "[4].href", is("http://localhost:8083/actors/200"));
